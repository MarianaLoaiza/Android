       ...
       /* btnRegiter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!Password.isEmpty() ){
                    ...
                    Cursor fila =  BaseDeDatos.rawQuery("select name from registro where password="+Password, null);
                    ...
                    Toast.makeText(getContext(), "Debes ingresar todos los datos", Toast.LENGTH_SHORT).show();
                }
